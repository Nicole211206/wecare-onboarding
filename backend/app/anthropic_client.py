...
Estrutura esperada:
{"quartos":0,"salas":0,"banheirosCompletos":0,"banheirosLavabo":0,"cozinha":0,"lavanderia":0,"areaExterna":0,"varanda":0,"camas":[{"tipo":"Queen","qtd":1}],"proprietarioNome":"","proprietarioTel":"","proprietarioEmail":"","tipoDocumento":"","cpf":"","cnpj":"","razaoSocial":"","dadosBancarios":"","chavePix":"","endereco":"","wifi_rede":"","wifi_senha":"","acesso":"","senha_porta":"","vaga":"","zelador_nome":"","zelador_tel":"","observacoes":"","short_stay_permitido":"","restricoes":"","comissao_pct":0,"comissao_base":"","valor_setup_cobrado":0,"fonte_valor_setup_cobrado":"","definicoes":{"seguroEasyCover":false,"kitAmenities":false,"internetClaro":false,"ecohost":false,"fechaduraEletronica":false},"formRascunho":{"q9":"","q81":"","q82":"","q83":"","q86":""}}
Regras:
- Use 0, "" ou false para campos não encontrados. NÃO invente informações.
- PRIORIDADE DE FONTE para qualquer dado comercial/financeiro (comissão, taxa de setup, seguro, taxas, pagadoria, dados bancários): o CONTRATO ASSINADO é a ÚNICA fonte válida. Documentos do tipo proposta, minuta, orçamento, e-mail de negociação ou apresentação comercial são preliminares e podem estar desatualizados — NUNCA use um valor desses documentos se houver um contrato assinado na pasta, mesmo que o contrato seja mais difícil de ler. Se houver contrato assinado mas você não encontrar o valor dentro dele, deixe o campo em branco (0/"") em vez de usar o valor de uma proposta.
...
- tipoDocumento: "cnpj" se o contrato for assinado por uma empresa (tiver razão social e CNPJ como parte contratante), "cpf" se for pessoa física. Se não conseguir identificar com segurança, deixe em branco.
- cpf: CPF do proprietário pessoa física, ou da pessoa física responsável/assinante quando o contrato for de uma pessoa jurídica.
- cnpj / razaoSocial: só preencha se o proprietário contratante for pessoa jurídica (empresa), lidos exatamente como no documento.
- dadosBancarios: banco, agência e conta informados para repasse/pagamento ao proprietário — copie como está no documento (não precisa reformatar).
- chavePix: chave PIX do proprietário, se houver, exatamente como escrita no documento.
