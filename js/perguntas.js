...
window.FORM_SECOES = [
  ...
  },
  {
    ...
    perguntas: [
      ...
      { id: 'q32', label: 'JACUZZI: quantas pessoas comporta e se é do condomínio (há regras?) ou do imóvel (há manual?)', tipo: 'textarea' },
      { id: 'q33', label: 'PISCINA: se é do condomínio ou no imóvel, regras para utilização e horários.', tipo: 'textarea' },
      ...
      { id: 'q39', label: 'Equipamentos de ginástica: tipo (elíptico, pesos, bicicleta, esteira, tapete de ioga, etc.) e se é do condomínio (há regras?) ou do imóvel', tipo: 'textarea' },
      { id: 'q40', label: 'PIANO E INSTRUMENTOS: tipo e se há outros instrumentos musicais (violão, guitarra, etc.)', tipo: 'textarea' },
      { id: 'q41', label: 'SISTEMA DE SOM: tipo (toca-discos, home theater, receiver, caixa bluetooth, etc.) e se há manual', tipo: 'textarea' },
      { id: 'q42', label: 'CINEMA: se é do condomínio (há regras para utilização?) ou do imóvel', tipo: 'textarea' },
      { id: 'q43', label: 'Tênis de mesa/Mesa de bilhar: se é do condomínio (há regras?) ou do imóvel', tipo: 'textarea' },
      { id: 'q65', label: 'ACADEMIA: se é do condomínio ou dentro do imóvel. Por favor explique as regras e horários para utilização', tipo: 'textarea' },
      { id: 'q66', label: 'SAUNA: se é do condomínio ou dentro do imóvel. Por favor explique as regras e horários para utilização', tipo: 'textarea' },
      ...
      { id: 'q52', label: 'LAREIRA interna: tipo (elétrica, etanol, gás, pellets, lenha, etc.) e se há combustível a disposição', tipo: 'textarea' },
    ]
  },
  {
    ...
    icon: 'utensils',
    perguntas: [
      { id: 'q55', label: 'CAFETEIRA: tipo (cápsula/modelo, elétrica, coador, etc.) e quantidade', tipo: 'textarea' },
      { id: 'q56', label: 'FORNO: tipo (elétrico, gás, indução, etc.)', tipo: 'text' },
      { id: 'q57', label: 'TAÇAS DE VINHO: material (vidro, acrílico, etc.) e quantidade', tipo: 'text' },
